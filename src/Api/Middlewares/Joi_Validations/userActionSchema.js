...
const issueHistorySchema = Joi.object({
  ...
  before_status: Joi.string().valid('Pending', 'In Progress', 'On Hold', 'Resolved', 'To Be Tested', 'Tested', 'Commited', 'Rejected').required(),
  after_status: Joi.string().valid('Pending', 'In Progress', 'On Hold', 'Resolved', 'To Be Tested', 'Tested', 'Commited', 'Rejected').required(),
